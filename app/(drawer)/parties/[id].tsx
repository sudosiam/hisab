  ...
  const localStyles = useMemo(
    () =>
      StyleSheet.create({
        ...
        badgeText: { fontSize: 11, fontWeight: '600', color: colors.primary, textTransform: 'capitalize' },
        ...
        editBtnText: { color: colors.onPrimaryContainer, fontWeight: '600', fontSize: 13 },
        financeCard: {
          ...cardSurface(colors, isDark),
          marginBottom: spacing.md,
          paddingHorizontal: spacing.md,
        ...
        historyType: { fontSize: 10, fontWeight: '600', color: colors.primary, marginTop: 1 },
        ...
        historyDue: { fontSize: 11, color: colors.danger, fontWeight: '600' },
        form: {
          ...cardSurface(colors, isDark),
          marginBottom: spacing.md,
          padding: spacing.md,
