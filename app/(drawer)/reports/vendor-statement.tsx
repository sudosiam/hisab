...
import { shareVendorStatementPdf } from '../../../src/services/vendorStatementPdf';
...
export default function VendorStatementReportScreen() {
  ...
  const [vendorParty, setVendorParty] = useState<Party | null>(null);
  ...
  const exportPdf = useCallback(async () => {
    ...
    if (!trimmed || hint) {
      return {
        success: false,
        message: 'Choose a vendor and date range before downloading the PDF.',
      };
    }
    return shareVendorStatementPdf({
      vendorName: trimmed,
      vendorPhone: vendorParty?.phone,
      fromDate,
      toDate,
      openingBalance,
      closingBalance,
  ...
  }, [vendorName, hint, vendorParty, fromDate, toDate, openingBalance, closingBalance, lines]);
